...
#    raise ProtocolEntity2::DomainError.new unless @args.first == '01'
  ...
  def self.from_entity(entity, created_by_address)
    raise ProtocolEntity2::DomainError.new unless entity[:media_type] == 1
    ...
    return ProtocolEntityPostMedia2.new(ProtocolEntity2::OP_PREFIX + PREFIX, payload, created_by_address)
  end
